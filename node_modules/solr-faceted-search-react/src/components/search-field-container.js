	...
	render() {
		...
		return (
			...
			*/}
				...
				<button className={cx({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss, "pull-right": bootstrapCss, "btn-success": bootstrapCss })}
					type='submit'>
...
class SearchFieldContainer extends React.Component {
	...
	render() {
		...
		return (
			<div className={cx({ "col-md-9": bootstrapCss })}>
				<div className={cx({ "panel": bootstrapCss, "panel-default": bootstrapCss })}>
					...
					<div className={cx({ "panel-footer": bootstrapCss })}>
						<PostQueryButton query={query} onChange={onChangeQuery} bootstrapCss={bootstrapCss} numFound={numFound} />
						<button className={cx({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss, "pull-right": bootstrapCss })}
							onClick={onNewSearch}>
							Réinitialiser
