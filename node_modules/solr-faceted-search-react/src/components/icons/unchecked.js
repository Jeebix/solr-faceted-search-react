...
class UncheckedIcon extends React.Component {
	render() {
		let title = this.props.title != null ? <title>{this.props.title}</title>: null;

		return (
			<svg className="checkbox-icon unchecked" onClick={this.props.onClick}  viewBox="0 0 401.998 401.998" width="12">
