...
class SolrFacetedSearch extends React.Component {
	...
	render() {
		...
		const CurrentQueryRawComponent = customComponents.searchFields.currentQueryRaw;
		...
		return (
			<div className={cx("solr-faceted-search", {"container": bootstrapCss, "col-md-12": bootstrapCss})}>
				<SearchFieldContainerComponent  bootstrapCss={bootstrapCss} onNewSearch={this.props.onNewSearch} onChangeQuery={onSearchFieldChange} query={query} numFound={results.numFound}>
				...
				<ResultContainerComponent bootstrapCss={bootstrapCss}>
					...
					{pagination}
					<CurrentQueryRawComponent {...this.props} onChange={onSearchFieldChange}/>
