...
},{"_process":12}],5:[function(_dereq_,module,exports){
(function (process){
/**
...
},{"./emptyFunction":3,"_process":12}],6:[function(_dereq_,module,exports){
...
},{"is-function":8}],7:[function(_dereq_,module,exports){
(function (global){
var win;
...
},{"_process":12}],10:[function(_dereq_,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"for-each":6,"trim":19}],12:[function(_dereq_,module,exports){
...
},{"./lib/ReactPropTypesSecret":17,"_process":12,"fbjs/lib/invariant":4,"fbjs/lib/warning":5}],14:[function(_dereq_,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":17,"fbjs/lib/emptyFunction":3,"fbjs/lib/invariant":4}],15:[function(_dereq_,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":13,"./lib/ReactPropTypesSecret":17,"_process":12,"fbjs/lib/emptyFunction":3,"fbjs/lib/invariant":4,"fbjs/lib/warning":5,"object-assign":10}],16:[function(_dereq_,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./factoryWithThrowingShims":14,"./factoryWithTypeCheckers":15,"_process":12}],17:[function(_dereq_,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"cookie":2,"is-node":9,"object-assign":10}],19:[function(_dereq_,module,exports){
...
},{"./v1":23,"./v4":24}],21:[function(_dereq_,module,exports){
/**
...
},{"./lib/bytesToUuid":21,"./lib/rng":22}],24:[function(_dereq_,module,exports){
var rng = _dereq_('./lib/rng');
var bytesToUuid = _dereq_('./lib/bytesToUuid');
...
},{"./lib/bytesToUuid":21,"./lib/rng":22}],25:[function(_dereq_,module,exports){
"use strict";
...
},{"global/window":7,"is-function":8,"parse-headers":11,"xtend":26}],26:[function(_dereq_,module,exports){
...
},{"./solr-query":29,"xhr":25}],28:[function(_dereq_,module,exports){
"use strict";
	...
	_createClass(SolrClient, [{
		...
		value: function setInitialQuery(queryToMerge) {
			...
			this.state.query.searchFields = this.state.query.searchFields.map(function (sf) {
				return searchFieldsToMerge // For every searchFields
				.map(function (sfm) {
					return sfm.field.toString();
				}) // get field(s) as a string
				.indexOf(sf.field.toString()) > -1 // if field in searchFieldsToMerge is found in current search fields
				//
				? _extends({}, sf, { value: searchFieldsToMerge.find(function (sfm) {
						return sfm.field.toString() === sf.field.toString();
					}).value,
					invert: searchFieldsToMerge.find(function (sfm) {
						return sfm.field.toString() === sf.field.toString();
					}).invert
					//
				}) : sf;
			...
			this.state.query.sortFields = this.state.query.sortFields.map(function (sf) {
				return sortFieldsToMerge.map(function (sfm) {
					return sfm.field.toString();
				}).indexOf(sf.field.toString()) > -1 ? _extends({}, sf, { value: sortFieldsToMerge.find(function (sfm) {
						return sfm.field.toString() === sf.field.toString();
					}).value }) : sf;
			});
		}
		...
		value: function setSearchFieldValue(field, value) {
			...
			console.log('setSearchMatrixFieldValue field :' + field);
			console.log('setSearchMatrixFieldValue value :' + value);
		...
		key: "setSearchMatrixFieldValue",
		value: function setSearchMatrixFieldValue(field, value) {}
	}, {
		key: "setFacetSort",
		...
		key: "setInvert",
		value: function setInvert(field, value) {
			var query = this.state.query;
			var searchFields = query.searchFields;

			var newFields = searchFields.map(function (searchField) {
				return searchField.field === field ? _extends({}, searchField, { invert: value }) : searchField;
			});
			var payload = { type: "SET_SEARCH_FIELDS", newFields: newFields };
			this.state.query = (0, _query2.default)(this.state.query, payload);
			this.onChange(this.state, this.getHandlers());
		...
		value: function getHandlers() {
			return {
				...
				onSearchMatrixFieldChanges: this.setSearchMatrixFieldValue.bind(this),
				...
				onSetInvert: this.setInvert.bind(this),
...
},{"../reducers/query":55,"../reducers/results":56,"./server":27}],29:[function(_dereq_,module,exports){
"use strict";
...
var rangeFacetToJSONQueryFilter = function rangeFacetToJSONQueryFilter(field) {
	var filters = field.value || [];
	if (filters.length < 2) {
		return null;
	}
...
var listFacetFieldToJSONQueryFilter = function listFacetFieldToJSONQueryFilter(field) {
	var filters = field.value || [];
	if (filters.length === 0) {
		return null;
	}
...
var matrixFacetFieldToQueryFilter = function matrixFacetFieldToQueryFilter(fields) {
	var filters = field_a.value || [];
	if (filters.length === 0) {
		return null;
	}
...
var matrixValueToQueryFilter = function matrixValueToQueryFilter(value) {
	...
	var parent_selector = 'object_type_s:contact';
	var line_key = 'enseigne_s';
	var column_key = 'type_cde_s';
	var cell_key = 'campagne_s';
	var kvSeparator = ':';
	var operator = ' AND ';

	var tokens = value.split('.');

	var _tokens = _slicedToArray(tokens, 4),
	    line_value = _tokens[0],
	    column_value = _tokens[1],
	    cell_value = _tokens[2],
	    state_value = _tokens[3];

	var filter = [[line_key, line_value].join(kvSeparator), [column_key, column_value].join(kvSeparator), [cell_key, cell_value].join(kvSeparator)].join(operator);

	var query_filter = state_value == 0 ? '' : (state_value < 0 ? '-' : '') + ("_query_:\"{!parent which=" + parent_selector + "}(" + filter + ")\"");

	return query_filter;
};

var matrixValueToQueryFilter2 = function matrixValueToQueryFilter2(value) {
	// Turns EDF.CDE.B.-1 into {!parent which=object_type:contact}-(enseigne_s:EDF AND type_s:CDE AND campagne_s:B)
	// Turns INI.KIT.Y.1 into {!parent which=object_type:contact}(enseigne_s:EDF AND type_s:CDE AND campagne_s:B)
	// Turns INI.KIT.Y.0 into an empty string
	...
	var _tokens2 = _slicedToArray(tokens, 4),
	    line_value = _tokens2[0],
	    column_value = _tokens2[1],
	    cell_value = _tokens2[2],
	    state_value = _tokens2[3];

	var filter = [[line_key, line_value].join(kvSeparator), [column_key, column_value].join(kvSeparator), [cell_key, cell_value].join(kvSeparator)].join(operator);

	var query_filter = state_value == 0 ? '' : "(" + filter + ")";

	return query_filter;
};

var matrixFacetFieldToJSONQueryFilter = function matrixFacetFieldToJSONQueryFilter(field) {
	var filters = field.value || [];
	//if (filters.length === 0) {
	//	return null;
	//}

	var inFilters = filters.filter(function (v) {
		return v.split('.')[3] > 0;
	});
	var exFilters = filters.filter(function (v) {
		return v.split('.')[3] < 0;
	});
	...
	console.log('------- MATRIX ----- FILTERS -----');
	var inQuery = inFilters.map(function (v) {
		return matrixValueToQueryFilter2(v);
	}).filter(function (v) {
		return v.length > 0;
	});
	var exQuery = exFilters.map(function (v) {
		return matrixValueToQueryFilter2(v);
	}).filter(function (v) {
		return v.length > 0;
	});
...
var fieldToJSONFacet = function fieldToJSONFacet(field) {
	var JSONFacetDef = {};
	JSONFacetDef[field.facet_name] = {};
	JSONFacetDef[field.facet_name].type = 'terms';
	JSONFacetDef[field.facet_name].field = field.field;
	field.multi_select ? JSONFacetDef[field.facet_name].domain = { excludeTags: field.facet_name } : {};
	field.nested ? JSONFacetDef[field.facet_name].domain = { blockChildren: field.child } : {};
...
var solrQuery2 = function solrQuery2(query) {
	...
	var queryParams = flatten(buildQuery(searchFields.concat(filters)));
	...
	facetFieldParam.map(function (f) {
		for (var key in f) {
			facet[key] = f[key];
		}
	});
	...
	result.filter = queryParams.filter(function (param) {
...
var solrQuery = function solrQuery(query) {
	var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { wt: "json" };
	//solr input as URI params output as json
	var searchFields = query.searchFields,
	    sortFields = query.sortFields,
	    rows = query.rows,
	    start = query.start,
...
var _matrixFacet = _dereq_("./matrix-facet");

var _matrixFacet2 = _interopRequireDefault(_matrixFacet);
...
var _currentQueryRaw = _dereq_("./current-query-raw");

var _currentQueryRaw2 = _interopRequireDefault(_currentQueryRaw);
...
},{"./current-query":32,"./current-query-raw":31,"./list-facet":36,"./matrix-facet":37,"./range-facet":38,"./results/container":40,"./results/count-label":41,"./results/csv-export":42,"./results/header":43,"./results/list":44,"./results/pagination":45,"./results/pending":46,"./results/preload-indicator":47,"./results/result":48,"./search-field-container":49,"./sort-menu":51,"./text-search":52}],31:[function(_dereq_,module,exports){
"use strict";
...
var _solrQuery = _dereq_("../../api/solr-query");
...
var CurrentQueryRaw = function (_React$Component) {
    _inherits(CurrentQueryRaw, _React$Component);

    function CurrentQueryRaw() {
        _classCallCheck(this, CurrentQueryRaw);

        return _possibleConstructorReturn(this, (CurrentQueryRaw.__proto__ || Object.getPrototypeOf(CurrentQueryRaw)).apply(this, arguments));
    }

    _createClass(CurrentQueryRaw, [{
        key: "render",
        value: function render() {
            ...
            var cible = root.getAttribute('cible');
            var req = root.getAttribute('req');
    ...
    return CurrentQueryRaw;
}(_react2.default.Component);

CurrentQueryRaw.propTypes = {
    bootstrapCss: _propTypes2.default.bool,
    onChange: _propTypes2.default.func,
    query: _propTypes2.default.object
};

exports.default = CurrentQueryRaw;

},{"../../api/solr-query":29,"classnames":1,"prop-types":16,"react":"react"}],32:[function(_dereq_,module,exports){
"use strict";
...
var CurrentQuery = function (_React$Component) {
	...
	_createClass(CurrentQuery, [{
		...
		key: "removeMatrixFacetValue",
		value: function removeMatrixFacetValue(field, values, value) {
			var foundIdx = values.indexOf(value);
			if (foundIdx > -1) {
				this.props.onChange(field, values.filter(function (v, i) {
					return i !== foundIdx;
		...
		key: "formatRenderMatrixValue",
		value: function formatRenderMatrixValue(value) {
			var enseigne = void 0,
			    cmdKit = void 0,
			    camp = void 0,
			    rest = void 0;
			...
			var _value$split2 = _slicedToArray(_value$split, 4);

			enseigne = _value$split2[0];
			cmdKit = _value$split2[1];
			camp = _value$split2[2];
			rest = _value$split2[3];


			return enseigne + " " + cmdKit + "@" + camp;
		}
	}, {
		key: "getCellStatusMatrixValue",
		value: function getCellStatusMatrixValue(value) {
			var enseigne = void 0,
			    cmdKit = void 0,
			    camp = void 0,
			    rest = void 0;
			...
			var _value$split4 = _slicedToArray(_value$split3, 4);

			enseigne = _value$split4[0];
			cmdKit = _value$split4[1];
			camp = _value$split4[2];
			rest = _value$split4[3];


			var cellStatus = rest != -1;
			...
			switch (searchField.type) {
				case "list-facet":
					return searchField.value.map(function (val, i) {
						return _react2.default.createElement(
							"span",
							{ className: (0, _classnames2.default)({ "label": bootstrapCss, "label-primary": bootstrapCss }, { "inverted": searchField.invert }), key: i,
				...
				case "range-facet":
					return _react2.default.createElement(
						"span",
						{ className: (0, _classnames2.default)({ "label": bootstrapCss, "label-primary": bootstrapCss }),
							onClick: function onClick() {
				...
				case "matrix-facet":
					return searchField.value.map(function (val, i) {
						return _react2.default.createElement(
							"span",
							{ className: (0, _classnames2.default)({ "label": bootstrapCss, "label-primary": bootstrapCss }, { "inverted": !_this2.getCellStatusMatrixValue(val) }), key: i,
								onClick: function onClick() {
									return _this2.removeMatrixFacetValue(searchField.field, searchField.value, val);
								} },
							_this2.formatRenderMatrixValue(val),
							_react2.default.createElement(
								"a",
								null,
								bootstrapCss ? _react2.default.createElement("span", { className: "glyphicon glyphicon-remove-sign" }) : "❌"
		...
		value: function render() {
			...
			if (odds.length === 0 && evens.length === 0) {
				return _react2.default.createElement(
					"div",
					{ className: (0, _classnames2.default)("current-query", { "panel-body": bootstrapCss }), id: "current" },
					_react2.default.createElement(
						"div",
						{ className: (0, _classnames2.default)({ "row": bootstrapCss }) },
						_react2.default.createElement(
							"ul",
							{ className: (0, _classnames2.default)({ "col-md-12": bootstrapCss }) },
							_react2.default.createElement(
								"li",
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"ul",
						{ className: (0, _classnames2.default)({ "col-md-6 col-sm-6": bootstrapCss }) },
						evens.map(function (searchField, i) {
							return _react2.default.createElement(
								...
								_react2.default.createElement(
									"div",
									{ className: (0, _classnames2.default)("row-fluid") },
...
},{"../../api/solr-query":29,"classnames":1,"prop-types":16,"react":"react"}],33:[function(_dereq_,module,exports){
"use strict";
...
var CheckedIcon = function (_React$Component) {
	...
	_createClass(CheckedIcon, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"svg",
				{ className: "checkbox-icon checked", onClick: this.props.onClick, viewBox: "0 0 489 402", width: "14" },
				title,
...
},{"prop-types":16,"react":"react"}],34:[function(_dereq_,module,exports){
"use strict";
...
var UncheckedIcon = function (_React$Component) {
	...
	_createClass(UncheckedIcon, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"svg",
				{ className: "checkbox-icon unchecked", onClick: this.props.onClick, viewBox: "0 0 401.998 401.998", width: "12" },
...
},{"prop-types":16,"react":"react"}],36:[function(_dereq_,module,exports){
"use strict";
...
var ListFacetItem = function (_React$Component) {
	_inherits(ListFacetItem, _React$Component);

	function ListFacetItem(props) {
		_classCallCheck(this, ListFacetItem);

		var _this = _possibleConstructorReturn(this, (ListFacetItem.__proto__ || Object.getPrototypeOf(ListFacetItem)).call(this, props));
	...
	_createClass(ListFacetItem, [{
		key: "handleFacetItemOver",
		value: function handleFacetItemOver() {
			var newLabel = '';
		...
		key: "handleFacetItemOut",
		value: function handleFacetItemOut() {
			var newLabel = '';
			this.setState({ facetInclude: newLabel }, function () {
				console.log(this.state.facetInclude);
			});
		...
		value: function render() {
			...
			var _props = this.props,
			    value = _props.value,
			    facetVal = _props.facetVal,
			    count = _props.count,
			    facetField = _props.facetField,
			    onSelect = _props.onSelect,
			    inverted = _props.inverted;


			var invertedClassName = inverted && value.indexOf(facetVal) > -1 ? "inverted" : "";
				...
				_react2.default.createElement(
					...
					{ className: "facet-item-type-" + this.props.facetField + "  " + invertedClassName + " facet-item-list",
						...
						onMouseOver: function onMouseOver(e) {
							return _this2.handleFacetItemOver(e);
						},
						onMouseOut: function onMouseOut(e) {
							return _this2.handleFacetItemOut(e);
						} },
					_react2.default.createElement(
						"div",
						{ className: 'list-facet-item-row facet-item-value col-md-9 col-sm-9' },
						_react2.default.createElement(
							"p",
							{ className: "managed-wrap " + invertedClassName },
							facetVal
						)
					),
					_react2.default.createElement(
						"div",
						{ className: 'facet-item-count col-md-2 col-sm-2' },
						_react2.default.createElement(
							"p",
							{ id: "facet-value-selection", className: invertedClassName },
							parseInt(count).toLocaleString().replace(',', '&thinsp;')
						)
					),
					_react2.default.createElement(
						"div",
						{ className: 'facet-item-select col-md-1 col-sm-1' },
						value.indexOf(facetVal) > -1 ? _react2.default.createElement(_checked2.default, null) : _react2.default.createElement(_unchecked2.default, null)
					)
				)
			);
		}
	...
	return ListFacetItem;
}(_react2.default.Component);

;

var ListFacet = function (_React$Component2) {
	_inherits(ListFacet, _React$Component2);

	function ListFacet(props) {
		_classCallCheck(this, ListFacet);

		var _this3 = _possibleConstructorReturn(this, (ListFacet.__proto__ || Object.getPrototypeOf(ListFacet)).call(this, props));
	...
	_createClass(ListFacet, [{
		...
		key: "handleCheckBoxOn",
		value: function handleCheckBoxOn() {
			// console.debug("### Checkbox was ticked ###");
			// this.setState({facetInclude : 'exclude'}, function () {
			// console.log(this.state.facetInclude);});
		}
	}, {
		key: "handleCheckBoxOff",
		value: function handleCheckBoxOff() {
		...
		value: function render() {
			...
			var _props2 = this.props,
			    query = _props2.query,
			    label = _props2.label,
			    facets = _props2.facets,
			    field = _props2.field,
			    value = _props2.value,
			    bootstrapCss = _props2.bootstrapCss,
			    facetSort = _props2.facetSort,
			    collapse = _props2.collapse,
			    invert = _props2.invert,
			    icon_class = _props2.icon_class,
			    group = _props2.group,
			...
			var facetCounts = facets.buckets ? facets.buckets.map(function (b) {
				return b.count;
			}) : [];
			var facetValues = facets.buckets ? facets.buckets.map(function (b) {
				return b.val;
			}) : [];
			...
			var showMoreLink = truncateFacetListsAt > -1 && truncateFacetListsAt < facetValues.length ? _react2.default.createElement(
				...
				{ className: (0, _classnames2.default)({ "list-group-item": bootstrapCss }), onClick: function onClick() {
						return _this4.setState({ truncateFacetListsAt: -1 });
					} },
				"Tout montrer (",
				facetValues.length,
				")"
			...
			var toggleInvertLink = _react2.default.createElement(
				"a",
				{ id: "invert-link", className: (0, _classnames2.default)({ "pull-right": bootstrapCss }, { "inverted": invert }), onClick: this.toggleInvert.bind(this) },
				invert ? 'inversé' : 'inverser'
			);

			var idlistFacetItem = "list-facet-item-" + (0, _uuid.v4)();

			return _react2.default.createElement(
				"li",
				{ className: (0, _classnames2.default)("facet-box", "list-facet", { "list-group-item": bootstrapCss }, query.searchFields.filter(function (f) {
						return f.field == field;
					}).shift().grid), id: "solr-list-facet-" + field },
				_react2.default.createElement(
					"header",
					null,
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"p",
							{ onClick: this.toggleExpand.bind(this), className: (0, _classnames2.default)(group) },
							...
							_react2.default.createElement("i", { className: (0, _classnames2.default)("fa", icon_class), "aria-hidden": "true" }),
							label
						)
					)
				),
         ...
         value porte le contenu de la requête */
						facetValues.filter(function (facetValue, i) {
							return truncateFacetListsAt < 0 || i < truncateFacetList;
						}).map(function (facetValue, i) {
							return _this4.state.filter.length === 0 || facetValue.toLowerCase().indexOf(_this4.state.filter.toLowerCase()) > -1 ? _react2.default.createElement(ListFacetItem, { facetVal: facetValue,
								value: value,
								count: facetCounts[i],
								facetField: field,
								inverted: invert,
								onSelect: function onSelect(e) {
									return _this4.handleClick(e, facetValue);
								},
								key: facetValue + "-" + idlistFacetItem }) : null;
						}),
						showMoreLink
					),
					facetValues.length > 6 ? _react2.default.createElement(
						"div",
						null,
						_react2.default.createElement(
							"div",
							{ id: "filter-div", className: (0, _classnames2.default)({ "col-md-6 col-sm-6": bootstrapCss, "form-group": bootstrapCss }) },
							_react2.default.createElement("input", { id: "filter-input", className: (0, _classnames2.default)({ "form-control": bootstrapCss, "input-sm": bootstrapCss }),
								onChange: function onChange(ev) {
									return _this4.setState({ filter: ev.target.value });
								},
						...
						_react2.default.createElement(
							"div",
							{ id: "facet-sort-div", className: (0, _classnames2.default)({ "btn-group": bootstrapCss }) },
							_react2.default.createElement(
								"button",
								{ className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-xs": bootstrapCss, active: facetSortValue === "index" }),
									onClick: function onClick() {
										return _this4.props.onFacetSortChange(field, "index");
									} },
								"a-z"
							),
							_react2.default.createElement(
								...
								{ className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-xs": bootstrapCss, active: facetSortValue === "count" }),
									onClick: function onClick() {
										return _this4.props.onFacetSortChange(field, "count");
									} },
								"0-9"
							)
						),
						_react2.default.createElement(
							"button",
							{ className: (0, _classnames2.default)({ "col-md-2 col-sm-2": bootstrapCss, "pull-right": bootstrapCss, "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-xs": bootstrapCss }),
								onClick: function onClick() {
									return _this4.props.onChange(field, []);
								} },
							"Reset"
						)
					) : null
...
ListFacet.propTypes = {
	...
	onSetInvert: _propTypes2.default.func,
	query: _propTypes2.default.object,
...
},{"../icons/checked":33,"../icons/unchecked":35,"classnames":1,"prop-types":16,"react":"react","uuid":20}],37:[function(_dereq_,module,exports){
"use strict";
...
var MatrixCell = function (_React$Component) {
	_inherits(MatrixCell, _React$Component);

	function MatrixCell() {
		_classCallCheck(this, MatrixCell);

		return _possibleConstructorReturn(this, (MatrixCell.__proto__ || Object.getPrototypeOf(MatrixCell)).apply(this, arguments));
	}
	...
	_createClass(MatrixCell, [{
		...
		value: function render() {
			...
			var bootstrapCss = true;

			return _react2.default.createElement(
				"button",
				{ className: (0, _classnames2.default)({ "btn btn-default": bootstrapCss }, { 'selected': this.props.cell.status > 0 }, { 'rejected': this.props.cell.status < 0 }),
					onClick: function onClick(e) {
						return _this2.props.cellClickHandler(e, _this2.props.cell.camp, _this2.props.row_id, _this2.props.col_id, _this2.props.cell.status);
					} },
...
var MatrixRow = function (_React$Component2) {
	_inherits(MatrixRow, _React$Component2);

	function MatrixRow() {
		_classCallCheck(this, MatrixRow);

		return _possibleConstructorReturn(this, (MatrixRow.__proto__ || Object.getPrototypeOf(MatrixRow)).apply(this, arguments));
	}
	...
	_createClass(MatrixRow, [{
		...
		value: function render() {
			...
			// const columnHeaderStyle = {textAlign: "center"};
			var bootstrapCss = true;
			var idMatrixCellCDE = "matrix-cell-CDE-" + (0, _uuid.v4)();
			var idMatrixCellKIT = "matrix-cell-KIT-" + (0, _uuid.v4)();

			return _react2.default.createElement(
				"tr",
				{ className: (0, _classnames2.default)('matrix-facet-table') },
				_react2.default.createElement(
					"td",
					null,
					_react2.default.createElement(
						"button",
						{ className: (0, _classnames2.default)({ "btn btn-sm": bootstrapCss }, this.props.row_content.class) },
						this.props.row_name
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: (0, _classnames2.default)({ "btn-group btn-group-sm btn-block": true }) },
						this.props.row_content.CDE.map(function (k) {
							return _react2.default.createElement(MatrixCell, { cell: k,
								row_id: _this4.props.row_id,
								col_id: 'CDE',
								onChange: _this4.props.onChange,
								field: _this4.props.field,
								value: _this4.props.value,
								cellClickHandler: _this4.props.cellClickHandler,
								key: "idMatrixCellCDE-" + k.camp });
						})
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: (0, _classnames2.default)({ "btn-group btn-group-sm btn-block": true }) },
						this.props.row_content.KIT.map(function (k) {
							return _react2.default.createElement(MatrixCell, { cell: k,
								row_id: _this4.props.row_id,
								col_id: 'KIT',
								onChange: _this4.props.onChange,
...
var MatrixFacet = function (_React$Component3) {
	_inherits(MatrixFacet, _React$Component3);

	function MatrixFacet(props) {
		_classCallCheck(this, MatrixFacet);

		var _this5 = _possibleConstructorReturn(this, (MatrixFacet.__proto__ || Object.getPrototypeOf(MatrixFacet)).call(this, props));
	...
	_createClass(MatrixFacet, [{
		key: "toggleCellStatus",
		value: function toggleCellStatus(current_cell_status) {
			var new_cell_status = current_cell_status;
		...
		key: "handleClick",
		value: function handleClick(e, value, row_id, col_id, status) {
			var newCellStatus = 0;
			if (e.shiftKey) {
			...
			var cell = [row_id, col_id, value, newCellStatus].join('.');
			var shortCell = [row_id, col_id, value].join('.');
			var suffix = '.0';
			// Remove all existing values for the cell and all neutral values
			this.props.onChange(this.props.field, this.props.value.filter(function (v) {
				return v.indexOf(shortCell) < 0 || v.indexOf(suffix, v.length - suffix.length) > 0;
			}).concat(cell));
		}
	}, {
		key: "toggleExpand",
		...
		key: "mergeMatrix",
		value: function mergeMatrix(m) {
			var values = this.props.value || ['....'];
			values.map(function (v) {
				var _v$split = v.split('.'),
				    _v$split2 = _slicedToArray(_v$split, 4),
				    row = _v$split2[0],
				    col = _v$split2[1],
				    cell = _v$split2[2],
				    state = _v$split2[3];

				(row.length > 0 && col.length) > 0 ? m[row][col].filter(function (c) {
					return c.camp == cell;
				}).map(function (c) {
					return c.status = parseInt(state);
				}) : 0;
			});
		...
		value: function render() {
			...
			var showMoreLink = truncateFacetListsAt > -1 && truncateFacetListsAt < facetValues.length ? _react2.default.createElement(
				"li",
				{ className: (0, _classnames2.default)({ "list-group-item": bootstrapCss }), onClick: function onClick() {
						return _this6.setState({ truncateFacetListsAt: -1 });
					} },
				"Tout montrer (",
				facetValues.length,
				")"
			...
			var invertedClassName = inverted && value.indexOf(facetVal) > -1 ? "rejected" : "";

			// const columnHeaderStyle = {textAlign: "center"};
			var idMatrixRow = "matrix-row-" + (0, _uuid.v4)();

			return _react2.default.createElement(
				"li",
				{ className: (0, _classnames2.default)("facet-box", "list-facet", { "list-group-item col-md-7 col-sm-12": bootstrapCss }), id: "solr-list-facet-" + field },
				_react2.default.createElement(
					"header",
				...
				expanded ? _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									"button",
									{ className: (0, _classnames2.default)('matrix-column', { "btn btn-info btn-sm btn-block": bootstrapCss }) },
									"Commandes"
								)
							),
							_react2.default.createElement(
					...
					_react2.default.createElement(
						"tbody",
						null,
						Object.keys(matrix).map(function (k) {
							return _react2.default.createElement(MatrixRow, { row_name: matrix[k].label,
								row_content: matrix[k],
								row_id: k,
								onChange: _this6.props.onChange,
								field: _this6.props.field,
								value: _this6.props.value,
								cellClickHandler: _this6.handleClick.bind(_this6),
								key: "idMatrixRow-" + matrix[k].label });
						})
					)
				) : null
			);
...
MatrixFacet.propTypes = {
	...
	field: _propTypes2.default.array.isRequired,
	label: _propTypes2.default.string,
	onChange: _propTypes2.default.func,
	onFacetSortChange: _propTypes2.default.func,
	onSetCollapse: _propTypes2.default.func,
...
exports.default = MatrixFacet;

},{"../icons/checked":33,"../icons/unchecked":35,"classnames":1,"prop-types":16,"react":"react","uuid":20}],38:[function(_dereq_,module,exports){
"use strict";
...
var RangeFacet = function (_React$Component) {
	...
	function RangeFacet(props) {
		...
		_this.handleLowerValueChange = _this.handleLowerValueChange.bind(_this);
		_this.handleUpperValueChange = _this.handleUpperValueChange.bind(_this);
		return _this;
	}
	...
	_createClass(RangeFacet, [{
		...
		value: function facetsToRange() {
			...
			var buckets = facets.buckets ? facets.buckets.map(function (b) {
				return b.val;
			}) : [];
		...
		key: "buildNewRange",
		value: function buildNewRange() {
			var leftInputValue = parseInt(document.getElementById("input-range-left").value);
			var rightInputValue = parseInt(document.getElementById("input-range-right").value);
			var range = this.facetsToRange();
			var lowerLimit = this.getPercentage(range, leftInputValue);
			var upperLimit = this.getPercentage(range, rightInputValue);
			var newRange = { lowerLimit: lowerLimit, upperLimit: upperLimit, refresh: true };
			return newRange;
		}
	}, {
		key: "onRangeUpdate",
		value: function onRangeUpdate(ev) {
			// console.log("############### onRangeUpdate");
			var newRange = this.buildNewRange();
		...
		key: "handleLowerValueChange",
		value: function handleLowerValueChange(ev) {
			this.setState({ lowerValue: ev.target.value });
		}
	}, {
		key: "handleUpperValueChange",
		value: function handleUpperValueChange(ev) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"li",
				{ className: (0, _classnames2.default)("facet-box", "range-facet", { "list-group-item col-md-5 col-sm-12": bootstrapCss }), id: "solr-range-facet-" + field },
				_react2.default.createElement(
					"header",
					{ onClick: this.toggleExpand.bind(this) },
					_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-4 col-sm-4 pull-left": bootstrapCss }) },
							_react2.default.createElement("input", { id: "input-range-left", className: (0, _classnames2.default)("range-input", { "form-control input-sm": bootstrapCss }),
								type: "text",
						...
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-4 col-sm-4 pull-right": bootstrapCss }) },
							_react2.default.createElement("input", { id: "input-range-right", className: (0, _classnames2.default)("range-input", { "form-control input-sm": bootstrapCss }),
								type: "text",
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"button",
							{ className: (0, _classnames2.default)("clear-button", { "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-xs": bootstrapCss, "pull-right": bootstrapCss }),
								onClick: function onClick() {
...
},{"./range-slider":39,"classnames":1,"prop-types":16,"react":"react"}],39:[function(_dereq_,module,exports){
"use strict";
...
var RangeSlider = function (_React$Component) {
	...
	_createClass(RangeSlider, [{
		...
		value: function getRangePath() {
			console.debug(this.state.upperLimit);
			return "M" + Math.floor(this.state.lowerLimit * 400) + " 13 L " + Math.ceil(this.state.upperLimit * 400) + " 13 Z";
		}
	}, {
		key: "getRangeCircle",
		value: function getRangeCircle(key) {
			var percentage = this.state[key];
			// console.log("GetRange percentage : ", percentage);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement("circle", {
						className: this.state.hoverState === keys[0] ? "hovering" : "",
						cx: "0", cy: "13",
						onMouseDown: this.onMouseDown.bind(this, keys[0]),
						onTouchStart: this.onMouseDown.bind(this, keys[0]),
						r: "13" }),
					_react2.default.createElement("circle", {
						className: this.state.hoverState === keys[1] ? "hovering" : "",
						cx: "400", cy: "13",
						onMouseDown: this.onMouseDown.bind(this, keys[1]),
						onTouchStart: this.onMouseDown.bind(this, keys[1]),
						r: "13" })
				)
			);
		}
...
},{"prop-types":16,"react":"react","react-dom":"react-dom"}],40:[function(_dereq_,module,exports){
"use strict";
...
var ResultContainer = function (_React$Component) {
	...
	_createClass(ResultContainer, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ className: (0, _classnames2.default)("solr-search-results", { "col-md-3 col-sm-4": bootstrapCss }) },
				_react2.default.createElement(
					"div",
					{ className: (0, _classnames2.default)({ "panel": bootstrapCss, "panel-info": bootstrapCss }) },
					this.props.children
				)
			);
		}
...
},{"classnames":1,"prop-types":16,"react":"react"}],41:[function(_dereq_,module,exports){
"use strict";
...
var Result = function (_React$Component) {
	...
	_createClass(Result, [{
		...
		value: function render() {
			...
			return (
				//<label>
				//	{resultLabel.replace("%", numFound.toLocaleString().replace(',','&thinsp;'))}
				//</label>
				_react2.default.createElement(
					"div",
					{ className: (0, _classnames2.default)({ "clearfix": bootstrapCss }) },
					_react2.default.createElement(
						"div",
						{ className: (0, _classnames2.default)({ "row": bootstrapCss }) },
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-3": bootstrapCss, "media-icon": bootstrapCss }) },
							_react2.default.createElement("i", { className: (0, _classnames2.default)("fa", "fa-drivers-license-o fa-2x"), "aria-hidden": "true" })
						),
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-6": bootstrapCss, "media-count": bootstrapCss }) },
							numFound.toLocaleString().replace(',', '&thinsp;')
						),
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-3": bootstrapCss, "media-target": bootstrapCss }) },
							_react2.default.createElement(
								"button",
								{ type: "button", className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-outline-primary": bootstrapCss, "btn-xs": bootstrapCss }) },
								"Cibler"
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-3": bootstrapCss, "media-icon": bootstrapCss, "text-center": bootstrapCss }) },
							_react2.default.createElement("i", { className: (0, _classnames2.default)("fa", "fa-phone fa-2x"), "aria-hidden": "true" })
						),
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-6": bootstrapCss, "media-count": bootstrapCss }) },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"button",
								{ type: "button", className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-xs": bootstrapCss }) },
								"Cibler"
							)
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-3": bootstrapCss }, "media-icon", "text-center") },
							_react2.default.createElement("i", { className: (0, _classnames2.default)("fa", "fa-mobile fa-2x"), "aria-hidden": "true" })
						),
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-6": bootstrapCss, "media-count": bootstrapCss }) },
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-3": bootstrapCss }, "media-icon", "text-center") },
							_react2.default.createElement("i", { className: (0, _classnames2.default)("fa", "fa-envelope fa-2x"), "aria-hidden": "true" })
						),
						_react2.default.createElement(
							"div",
							{ className: (0, _classnames2.default)({ "col-md-6": bootstrapCss, "media-count": bootstrapCss }) },
...
},{"classnames":1,"prop-types":16,"react":"react"}],42:[function(_dereq_,module,exports){
"use strict";
...
},{"classnames":1,"react":"react"}],43:[function(_dereq_,module,exports){
"use strict";
...
var ResultHeader = function (_React$Component) {
	...
	_createClass(ResultHeader, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"div",
				{ className: (0, _classnames2.default)({ "panel-heading": bootstrapCss }), "data-spy": "affix", "data-offset-top": "150", "data-clampedwidth": ".panel", id: "search-results" },
				this.props.children
			);
		}
	}]);
...
},{"classnames":1,"prop-types":16,"react":"react"}],44:[function(_dereq_,module,exports){
"use strict";
...
},{"classnames":1,"prop-types":16,"react":"react"}],45:[function(_dereq_,module,exports){
"use strict";
...
},{"classnames":1,"prop-types":16,"react":"react"}],46:[function(_dereq_,module,exports){
"use strict";
...
},{"prop-types":16,"react":"react"}],47:[function(_dereq_,module,exports){
"use strict";
...
},{"classnames":1,"prop-types":16,"react":"react","react-dom":"react-dom"}],48:[function(_dereq_,module,exports){
"use strict";
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					fields.filter(function (field) {
						...
						return ["id", "Etat marketing", "Historique", "en gros"].indexOf(field.label) >= 0;
...
},{"classnames":1,"prop-types":16,"react":"react"}],49:[function(_dereq_,module,exports){
"use strict";
...
var _djangoCsrfToken = _dereq_("../django-csrf-token");

var _djangoCsrfToken2 = _interopRequireDefault(_djangoCsrfToken);
...
var PostQueryButton = function (_React$Component) {
	_inherits(PostQueryButton, _React$Component);

	function PostQueryButton() {
		_classCallCheck(this, PostQueryButton);

		return _possibleConstructorReturn(this, (PostQueryButton.__proto__ || Object.getPrototypeOf(PostQueryButton)).apply(this, arguments));
	}

	_createClass(PostQueryButton, [{
		key: "render",
		value: function render() {
			var _props = this.props,
			    bootstrapCss = _props.bootstrapCss,
			...
			return _react2.default.createElement(
				"form",
				{ action: "query/" + cible + "/", method: "POST" },
				_react2.default.createElement(_djangoCsrfToken2.default, null),
				...
				_react2.default.createElement("input", {
					...
					value: query ? (0, _solrQuery2.default)(query) : '{"error":"no_query"}'
				}),
				_react2.default.createElement("input", { type: "hidden", name: "count", value: numFound }),
				_react2.default.createElement(
					"button",
					{ id: "btn-submit", className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss, "pull-right": bootstrapCss, "btn-success": bootstrapCss }),
						type: "submit" },
					"Valider ma s\xE9lection"
				)
			);
		}
	}]);

	return PostQueryButton;
}(_react2.default.Component);
...
PostQueryButton.propTypes = {
	...
	onChange: _propTypes2.default.func,
	query: _propTypes2.default.object,
	numFound: _propTypes2.default.number
};

var SearchFieldContainer = function (_React$Component2) {
	_inherits(SearchFieldContainer, _React$Component2);
	...
	_createClass(SearchFieldContainer, [{
		...
		value: function render() {
			var _props2 = this.props,
			    bootstrapCss = _props2.bootstrapCss,
			    onNewSearch = _props2.onNewSearch,
			    query = _props2.query,
			    onChangeQuery = _props2.onChangeQuery,
			    numFound = _props2.numFound;


			return _react2.default.createElement(
				"div",
				{ className: (0, _classnames2.default)({ "col-md-9 col-sm-8": bootstrapCss }) },
				_react2.default.createElement(
					"div",
					{ id: "current-query-div", className: (0, _classnames2.default)({ "panel": bootstrapCss, "panel-default": bootstrapCss }) },
					_react2.default.createElement(
						"header",
						{ className: (0, _classnames2.default)({ "panel-heading": bootstrapCss }) },
						_react2.default.createElement(PostQueryButton, { query: query, onChange: onChangeQuery, bootstrapCss: bootstrapCss, numFound: numFound }),
						_react2.default.createElement(
							"button",
							{ className: (0, _classnames2.default)({ "btn": bootstrapCss, "btn-default": bootstrapCss, "btn-sm": bootstrapCss, "pull-right": bootstrapCss }),
								onClick: onNewSearch },
							"R\xE9initialiser"
						),
						_react2.default.createElement(
...
},{"../api/solr-query":29,"../django-csrf-token":53,"classnames":1,"prop-types":16,"react":"react"}],50:[function(_dereq_,module,exports){
"use strict";
...
var SolrFacetedSearch = function (_React$Component) {
	...
	_createClass(SolrFacetedSearch, [{
		...
		value: function render() {
			...
			var CurrentQueryRawComponent = customComponents.searchFields.currentQueryRaw;
			...
			console.debug("From solr search");
			console.debug(results);
			console.debug(searchFields);

			return _react2.default.createElement(
				"div",
				{ className: (0, _classnames2.default)("solr-faceted-search") },
				_react2.default.createElement(
					SearchFieldContainerComponent,
					{ bootstrapCss: bootstrapCss, onNewSearch: this.props.onNewSearch, onChangeQuery: onSearchFieldChange, query: query, numFound: results.numFound },
					...
					searchFields.map(function (searchField, i) {
						...
						var facets = type === "list-facet" || type === "range-facet" || type == "matrix-facet" ?
						//&& results.hasOwnProperty('facets['+searchField.facet_name+']')
						results.facets[searchField.facet_name] || [] : null;
						//&& resultsfacets[searchField.facet_name].hasOwnProperty('buckets')
				...
				_react2.default.createElement(
					...
					pagination,
					_react2.default.createElement(CurrentQueryRawComponent, _extends({}, this.props, { onChange: onSearchFieldChange }))
				)
			);
		}
	}]);
...
},{"./component-pack":30,"classnames":1,"prop-types":16,"react":"react"}],51:[function(_dereq_,module,exports){
"use strict";
...
},{"classnames":1,"prop-types":16,"react":"react","react-dom":"react-dom"}],52:[function(_dereq_,module,exports){
"use strict";
...
var TextSearch = function (_React$Component) {
	...
	_createClass(TextSearch, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				"li",
				{ className: (0, _classnames2.default)({ "list-group-item col-md-4": bootstrapCss }) },
				_react2.default.createElement(
					"header",
					{ onClick: this.toggleExpand.bind(this) },
					_react2.default.createElement(
...
},{"../icons/search":34,"classnames":1,"prop-types":16,"react":"react"}],53:[function(_dereq_,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DjangoCSRFToken = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _reactCookie = _dereq_("react-cookie");
...
var DjangoCSRFToken = function (_React$Component) {
  _inherits(DjangoCSRFToken, _React$Component);

  function DjangoCSRFToken() {
    _classCallCheck(this, DjangoCSRFToken);

    return _possibleConstructorReturn(this, (DjangoCSRFToken.__proto__ || Object.getPrototypeOf(DjangoCSRFToken)).apply(this, arguments));
  }

  _createClass(DjangoCSRFToken, [{
    key: "render",
    value: function render() {

      var csrfToken = _reactCookie2.default.load('csrftoken') ? _reactCookie2.default.load('csrftoken') : 'pasDeJetonCSRF';
...
exports.DjangoCSRFToken = DjangoCSRFToken;

},{"classnames":1,"react":"react","react-cookie":18,"react-dom":"react-dom"}],54:[function(_dereq_,module,exports){
"use strict";
...
},{"./api/solr-client":28,"./components/component-pack":30,"./components/solr-faceted-search":50}],55:[function(_dereq_,module,exports){
"use strict";
...
exports.default = function () {
	...
	console.debug("Type d'action (résultat) : ", action.type);
	switch (action.type) {
		case "SET_RESULTS":
			console.debug("Données des facettes en résultat : ", action.data.facets);
			return _extends({}, state, {
